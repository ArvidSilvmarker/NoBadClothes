...
namespace NoBadClothes
{
    public class GetWeatherFromSmhi : IGetWeather
    {
        ...
        {
            return new WeatherMapper().UpdateStation(GetJsonForecast(station), station);
        }
        ...
        private Forecast GetJsonForecast(Station station)
        {
            string scheme = @"https://";
            string hostPath =
        ...
        private string CoordinateWithDot(double coordinate)
        {
